resource "google_compute_instance_template" "cosmosnet_pro" {
...
# terraform import google_compute_instance_template.cosmosnet_pro projects/gbc-cosmos-pro/global/instanceTemplates/cosmosnet-pro
