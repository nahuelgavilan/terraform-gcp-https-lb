resource "google_compute_instance_template" "test_cosmos" {
...
# terraform import google_compute_instance_template.test_cosmos projects/gbc-cosmos-pro/global/instanceTemplates/test-cosmos
