resource "google_compute_instance_template" "cosmosnet_test" {
...
# terraform import google_compute_instance_template.cosmosnet_test projects/gbc-cosmos-pro/global/instanceTemplates/cosmosnet-test
