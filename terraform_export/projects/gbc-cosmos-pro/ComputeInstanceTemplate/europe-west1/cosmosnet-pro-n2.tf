resource "google_compute_instance_template" "cosmosnet_pro_n2" {
...
# terraform import google_compute_instance_template.cosmosnet_pro_n2 projects/gbc-cosmos-pro/global/instanceTemplates/cosmosnet-pro-n2
