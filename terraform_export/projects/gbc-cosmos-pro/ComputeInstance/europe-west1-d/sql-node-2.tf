resource "google_compute_instance" "sql_node_2" {
  attached_disk {
    device_name = "sql-node-2-data"
    mode        = "READ_WRITE"
    source      = "https://www.googleapis.com/compute/v1/projects/gbc-cosmos-pro/zones/europe-west1-d/disks/sql-node-2-data"
  }

  attached_disk {
    device_name = "sql-node-2-logs"
    mode        = "READ_WRITE"
    source      = "https://www.googleapis.com/compute/v1/projects/gbc-cosmos-pro/zones/europe-west1-d/disks/sql-node-2-logs"
  }

  boot_disk {
    auto_delete = true
    device_name = "sql-node-2"
    ...
    mode   = "READ_WRITE"
    source = "https://www.googleapis.com/compute/v1/projects/gbc-cosmos-pro/zones/europe-west1-d/disks/sql-node-2"
  }
...
# terraform import google_compute_instance.sql_node_2 projects/gbc-cosmos-pro/zones/europe-west1-d/instances/sql-node-2
