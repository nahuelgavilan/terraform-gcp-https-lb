resource "google_compute_instance" "cosmosnet_jm23" {
  boot_disk {
    auto_delete = true
    ...
    mode   = "READ_WRITE"
    source = "https://www.googleapis.com/compute/v1/projects/gbc-cosmos-pro/zones/europe-west1-b/disks/cosmosnet-jm23"
  }
...
# terraform import google_compute_instance.cosmosnet_jm23 projects/gbc-cosmos-pro/zones/europe-west1-b/instances/cosmosnet-jm23
