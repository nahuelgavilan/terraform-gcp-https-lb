resource "google_compute_instance" "interop" {
  boot_disk {
    auto_delete = true
    ...
    mode   = "READ_WRITE"
    source = "https://www.googleapis.com/compute/v1/projects/gbc-cosmos-pro/zones/europe-west1-b/disks/interop"
  }
...
# terraform import google_compute_instance.interop projects/gbc-cosmos-pro/zones/europe-west1-b/instances/interop
