resource "google_compute_instance" "cosmos_9tw8" {
  boot_disk {
    auto_delete = true
    ...
    mode   = "READ_WRITE"
    source = "https://www.googleapis.com/compute/v1/projects/gbc-cosmos-pro/zones/europe-west1-b/disks/cosmos-9tw8"
  }
...
# terraform import google_compute_instance.cosmos_9tw8 projects/gbc-cosmos-pro/zones/europe-west1-b/instances/cosmos-9tw8
